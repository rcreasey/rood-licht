...
ContractsController.index = function(req, res) {
  ...
  Contract.find({$or: filters, dateIssued: { $lt: moment(), $gt: moment().subtract('week', 8)._d }}).populate('startStation endStation').sort('-dateIssued').exec(function(err, contracts) {
